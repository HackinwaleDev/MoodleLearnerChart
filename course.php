...
$actionurl = new moodle_url('/report/chart/course.php');
$PAGE->set_context($context);
$PAGE->set_url('/report/chart/course.php', array('courseid' => $courseid));
$PAGE->set_title(get_string('pluginname', 'report_chart'));
$PAGE->set_heading(get_string('pluginname', 'report_chart'));
$PAGE->set_pagelayout('report');
echo $OUTPUT->header();
$renderable = new report_chart_renderable($course);
